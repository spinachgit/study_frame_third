...
public class D05_ParseHtmlCssLink {
    ...
    public static final String HTML = "src/main/webapp/resources/itextpdf/xml/test.html";
    public static final String CSS_DIR = "src/main/webapp/resources/itextpdf/xml/";
