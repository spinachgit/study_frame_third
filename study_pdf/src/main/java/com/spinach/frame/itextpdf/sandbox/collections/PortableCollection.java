package com.spinach.frame.itextpdf.sandbox.collections;
...
public class PortableCollection {
    ...
    public static final String HELLO = "src/main/webapp/resources/itextpdf/pdfs/hello.pdf";
    public static final String IMG = "src/main/webapp/resources/itextpdf/images/berlin2013.jpg";
