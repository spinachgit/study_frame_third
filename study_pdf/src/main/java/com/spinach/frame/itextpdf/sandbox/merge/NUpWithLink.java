...
public class NUpWithLink {
    public static final String SRC1 = "src/main/webapp/resources/itextpdf/pdfs/links1.pdf";
    public static final String SRC2 = "src/main/webapp/resources/itextpdf/pdfs/links2.pdf";
