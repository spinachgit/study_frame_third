...
public class TiledBackground {
    ...
    public static final String IMG1 = "src/main/webapp/resources/itextpdf/images/ALxRF.png";
    public static final String IMG2 = "src/main/webapp/resources/itextpdf/images/bulb.gif";
