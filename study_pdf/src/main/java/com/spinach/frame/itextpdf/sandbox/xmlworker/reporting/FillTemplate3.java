...
public class FillTemplate3 {
    ...
    public static final String PDF = "src/main/webapp/resources/itextpdf/pdfs/stationery_landscape.pdf";
    public static final String HTML = "src/main/webapp/resources/itextpdf/xml/movies.html";
    public static final String CSS = "src/main/webapp/resources/itextpdf/xml/style3.css";
