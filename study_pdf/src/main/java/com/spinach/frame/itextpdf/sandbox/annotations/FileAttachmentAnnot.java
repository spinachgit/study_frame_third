...
public class FileAttachmentAnnot {
    ...
    public static final String PATH = "src/main/webapp/resources/itextpdf/misc/test.docx";
    public static final String IMG = "src/main/webapp/resources/itextpdf/images/info.png";
