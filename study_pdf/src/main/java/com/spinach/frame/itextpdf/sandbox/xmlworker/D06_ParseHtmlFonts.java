...
public class D06_ParseHtmlFonts {
    ...
    public void createPdf(String file) throws IOException, DocumentException {
        ...
        fontProvider.register("src/main/webapp/resources/itextpdf/fonts/Cardo-Regular.ttf");
        fontProvider.register("src/main/webapp/resources/itextpdf/fonts/Cardo-Bold.ttf");
        fontProvider.register("src/main/webapp/resources/itextpdf/fonts/Cardo-Italic.ttf");
