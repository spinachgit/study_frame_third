...
public class RupeeSymbol {
    ...
    public static final String FONT1 = "src/main/webapp/resources/itextpdf/fonts/PlayfairDisplay-Regular.ttf";
    public static final String FONT2 = "src/main/webapp/resources/itextpdf/fonts/PT_Sans-Web-Regular.ttf";
    public static final String FONT3 = "src/main/webapp/resources/itextpdf/fonts/FreeSans.ttf";
