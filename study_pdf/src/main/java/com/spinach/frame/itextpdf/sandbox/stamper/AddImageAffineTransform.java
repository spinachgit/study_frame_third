...
public class AddImageAffineTransform {
    public static final String SRC = "src/main/webapp/resources/itextpdf/pdfs/hello.pdf";
    public static final String DEST = "results/stamper/hello_with_image.pdf";
    public static final String IMG = "src/main/webapp/resources/itextpdf/images/bruno.jpg";
