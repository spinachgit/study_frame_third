...
public class FillTemplate4 {
    ...
    public static final String XML = "src/main/webapp/resources/itextpdf/xml/movies.xml";
    public static final String CSS = "src/main/webapp/resources/itextpdf/xml/style4.css";
