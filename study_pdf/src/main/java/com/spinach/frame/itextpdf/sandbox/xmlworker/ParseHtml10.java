...
public class ParseHtml10 {
    ...
    public static final String HTML = "src/main/webapp/resources/itextpdf/xml/hebrew.html";
    ...
    public void createPdf(String file) throws IOException, DocumentException {
        ...
        fontProvider.register("src/main/webapp/resources/itextpdf/fonts/NotoSansHebrew-Regular.ttf");
