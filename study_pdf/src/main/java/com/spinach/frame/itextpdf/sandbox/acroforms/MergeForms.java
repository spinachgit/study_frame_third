...
public class MergeForms {
    ...
    public static final String SRC1 = "src/main/webapp/resources/itextpdf/pdfs/subscribe.pdf";
    public static final String SRC2 = "src/main/webapp/resources/itextpdf/pdfs/state.pdf";
