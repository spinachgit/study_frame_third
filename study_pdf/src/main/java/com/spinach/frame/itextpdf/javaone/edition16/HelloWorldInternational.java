...
public class HelloWorldInternational {
	...
	throws DocumentException, IOException {
        ...
        BaseFont bf_russian = BaseFont.createFont("src/main/webapp/resources/itextpdf/fonts/FreeSans.ttf", "CP1251", BaseFont.EMBEDDED);
        Font russian = new Font(bf_russian, 12);
        BaseFont bf_cjk = BaseFont.createFont("src/main/webapp/resources/itextpdf/fonts/NotoSansCJKsc-Regular.otf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED);
