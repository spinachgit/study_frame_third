...
import com.spinach.frame.itextpdf.zugferd.data.InvoiceData;
...
public class PdfInvoicesComfort {
    ...
    class MyFontProvider implements FontProvider {
        ...
        public MyFontProvider() throws DocumentException, IOException {
            regular = BaseFont.createFont("src/main/webapp/resources/itextpdf/fonts/OpenSans-Regular.ttf", BaseFont.IDENTITY_H, true);
            bold = BaseFont.createFont("src/main/webapp/resources/itextpdf/fonts/OpenSans-Bold.ttf", BaseFont.IDENTITY_H, true);
        }
    ...
    class MyImageProvider implements ImageProvider {
        ...
        public String getImageRootPath() {
            return "src/main/webapp/resources/itextpdf/zugferd/";
        }
    ...
    public static final String XSL = "src/main/webapp/resources/itextpdf/zugferd/invoice.xsl";
    public static final String CSS = "src/main/webapp/resources/itextpdf/zugferd/invoice.css";
    public static final String ICC = "src/main/webapp/resources/itextpdf/data/sRGB_CS_profile.icm";
