...
public class ImportXFDF {
    ...
    public static final String SRC = "src/main/webapp/resources/itextpdf/pdfs/Requisition_Fillable.pdf";
    public static final String XFDF = "src/main/webapp/resources/itextpdf/pdfs/data.xfdf";
