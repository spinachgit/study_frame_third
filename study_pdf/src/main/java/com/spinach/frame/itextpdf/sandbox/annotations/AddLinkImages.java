...
public class AddLinkImages {
    ...
    public void createPdf(String dest) throws IOException, DocumentException {
        ...
        p.add(createImage("src/main/webapp/resources/itextpdf/images/info.png", "http://itextpdf.com/"));
        p.add(createImage("src/main/webapp/resources/itextpdf/images/dog.bmp", "http://pages.itextpdf.com/ebook-stackoverflow-questions.html"));
        p.add(createImage("src/main/webapp/resources/itextpdf/images/fox.bmp", "http://stackoverflow.com/q/29388313/1622493"));
        p.add(createImage("src/main/webapp/resources/itextpdf/images/butterfly.wmf", "http://stackoverflow.com/questions/tagged/itext*"));
        document.add(p);
        document.close();
    }
