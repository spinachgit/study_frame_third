 ...
 */
package com.spinach.frame.itextpdf.sandbox.events;
...
public class Every25Words {
    ...
    public String readFile() throws IOException {
        ...
        BufferedReader in = new BufferedReader(
            new InputStreamReader(new FileInputStream("src/main/webapp/resources/itextpdf/text/liber1_1_la.txt"), "UTF8"));
        String str;
