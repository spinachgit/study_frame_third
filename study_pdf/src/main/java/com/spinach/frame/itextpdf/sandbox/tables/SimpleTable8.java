...
public class SimpleTable8 {
    ...
    public void createPdf(String dest) throws IOException, DocumentException {
        ...
        PdfReader reader = new PdfReader("src/main/webapp/resources/itextpdf/pdfs/header.pdf");
        ...
        reader = new PdfReader("src/main/webapp/resources/itextpdf/pdfs/footer.pdf");
