 ...
 */
package com.spinach.frame.itextpdf.sandbox.pdfa;
...
public class PdfA1A {
    ...
    public static final String DATA = "src/main/webapp/resources/itextpdf/data/united_states.csv";
    public static final String FONT = "src/main/webapp/resources/itextpdf/fonts/OpenSans-Regular.ttf";
    public static final String BOLD = "src/main/webapp/resources/itextpdf/fonts/OpenSans-Bold.ttf";
    ...
    public void createPdf(String dest) throws IOException, DocumentException {
        ...
        File file = new File("src/main/webapp/resources/itextpdf/data/sRGB_CS_profile.icm");
