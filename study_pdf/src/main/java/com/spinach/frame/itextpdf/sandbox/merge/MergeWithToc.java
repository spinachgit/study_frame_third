...
public class MergeWithToc {
    ...
    public static final String SRC1 = "src/main/webapp/resources/itextpdf/pdfs/united_states.pdf";
    public static final String SRC2 = "src/main/webapp/resources/itextpdf/pdfs/hello.pdf";
    public static final String SRC3 = "src/main/webapp/resources/itextpdf/pdfs/toc.pdf";
