...
public class D00_XHTML {
    ...
    public static final String WALDEN = "src/main/webapp/resources/itextpdf/html/walden.html";
    /** The name of a HTML file */
    public static final String THOREAU = "src/main/webapp/resources/itextpdf/html/thoreau.html";
