...
public class TransparentWatermark3 {
    ...
    public static final String SRC = "src/main/webapp/resources/itextpdf/pdfs/pages.pdf";
    public static final String DEST = "results/stamper/pages_watermarked3.pdf";
    public static final String IMG = "src/main/webapp/resources/itextpdf/images/itext.png";
